    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col md-4">
                        <h1 class="text-bold text-center">TAMBAH DATA NILAI TUGAS</h1>
                                                ...
                                                <tr class="text-sm-center">
                                                    ...
                                                    <td>
                                                        <input class="form-control text-sm-center" type="number"
                                                            name="id_tugas[{{ $loop->iteration }}]" readonly
                                                    ...
                                                    <td>
                                                        <input class="form-control text-sm-center" type="text"
                                                            ...
                                                            value={{ $item->pesertakelas->siswa->nis }}>
                                                    </td>
                                                    <td>
                                                        <input class="form-control text-sm-center" type="text"
                                                    ...
                                                    <td>
                                                        <input class="form-control-range text-sm-center" type="text"
                                                            name="tugas1[{{ $loop->iteration }}]">
                                                    </td>
                                                    <td>
                                                        <input class="form-control-range text-sm-center" type="text"
                                                            name="tugas2[{{ $loop->iteration }}]">
                                                    </td>
                                                    <td>
                                                        <input class="form-control-range text-sm-center" type="text"
                                                            name="tugas3[{{ $loop->iteration }}]">
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
