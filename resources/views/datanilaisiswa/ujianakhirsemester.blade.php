                ...
                <div class="col md-4">
                    ...
                    <div class="card card-success card-outline mt-4">
                        <div class="card-body">
                            ...
                            <a href="{{ '/datanilaisiswa/ujianakhirsemester/add' }}" class="btn btn-success btn-lg active btn-sm ml-2" role="button" aria-pressed="true">
                                Tambah Nilai
                            </a>
                            <br> <br>
                            @endif
                                ...
                                <table class="table mt-3 table-sm table-responsive-sm text-center" id="tablenilai">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-sm-center">
                                            ...
                                            <td>
                                                <a href="/datanilaisiswa/ujianakhirsemester/{{$item->id_uas}}/edit" class="badge badge-success">ubah</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
