                                ...
                                <table class="table mb-3 table-sm table-responsive-sm" id="tablenilai">
                                    <thead class="thead-dark">
                                        <tr class="text-center">
                                            ...
                                            <th scope="col" class="col-sm-2">NA</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @php
                                        ...
                                        @foreach ($rapor as $key => $item)
                                            @foreach ($item as $key1 => $item1)
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        @php
                                                            $final = ((isset($item1['tugas1']) ? $item1['tugas1'] : 0) + (isset($item1['tugas2']) ? $item1['tugas2'] : 0) + (isset($item1['tugas3']) ? $item1['tugas3'] : 0) + (isset($item1['uh1']) ? $item1['uh1'] : 0)) / 7;
                                                            echo round($final, 0);
                                                        @endphp
                                                    </td>
                                                </tr>
